...
import chap98_homework.nc230321.ContractEmployee;
import chap98_homework.nc230321.Employee;
import chap98_homework.nc230321.RegularEmployee;
import chap98_homework.nc230321.TempEmployee;
		...
		try {
			while (true) {
				...
				case 2:
					...
					hireYear = sc.nextInt();
					epList.add(new TempEmployee(eno, name, pay, 1, bonus));
					epList.get(epList.size() - 1).showEmployeeInfo();
				...
				case 3:
					...
					workDay = sc.nextInt();
					epList.add(new ContractEmployee(eno, name, pay, 1, bonus));
					epList.get(epList.size() - 1).showEmployeeInfo();
				...
				case 5:
					...
					eno = sc.nextInt();
					/*
					 * for (int i=0; i <epList.size(); i++) { if(epList.get(i).getEno() ==1) {
					 * epList.get(i).showEmployeeInfo(); System.out.println("----------------"); }
					 */
